# TEMPLATE 8 - PHP + APACHE
A simple Docker container to run php + Apache with some useful tools like composer, Node.js, npm, yarn, git, ssh and more. Used to build template8.
...
```sh
git clone git@github.com:wayoxmedia/template8.git
```
...
If this URL doesn't work, replace `template8.test` with localhost or 127.0.0.1
